CHAT_SYSTEM_PROMPT = """You are HelixAI, a customer-operations assistant.
...
INVESTIGATION_INTENT_SYSTEM_PROMPT = """Extract the user's customer-operations investigation request into the required schema.
